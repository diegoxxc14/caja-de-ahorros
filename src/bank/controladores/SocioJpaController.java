...
public class SocioJpaController implements Serializable {
    ...
    public int getSocioCount() {
        ...
        public Socio findByIdCliente(Cliente cliente) {
        EntityManager em = getEntityManager();
        TypedQuery<Socio> consSocio = em.createNamedQuery("cliente_socio", Socio.class);
        consSocio.setParameter("prmCliente", cliente.getId());
        return consSocio.getSingleResult();
    }
}
